    ...
    <div class="col-md-6 col-xs-6">
        <div class="form-group">
            ...
            <input type="password" id="senha_antiga" name="senha_antiga" class="form-control"
                   onchange="getSenhaAntiga()">
        </div>
        <div class="form-group">
            <label for="senha">Nova senha:<span style="color: red"> *</span></label><span><a id="gerarRandom"
                                                                                             onclick="randomString(); return false;"
                                                                                             style="display: none">Gerar
                    senha aleat&oacute;ria</a></span>
        ...
        <div class="form-group">
            <label>O usu&aacute;rio aceita ter sua imagem exposta no site: <input type="checkbox" name="permissao"
                                                                                  value="s" <? if ($usuario['permissao'] == "s") {
                    echo "checked";
                } ?>></label>
        </div>
